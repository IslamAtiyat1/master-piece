...
class ColorController extends Controller
{
    ...
    public function store(ColorFormRequest $request)
    {
        ...
        // call validated() on a validated form request instance, it returns an array of the validated and sanitized data.
    ...
    {
        $validatedData = $request->validated();
        //the incoming HTTP request made to the server
